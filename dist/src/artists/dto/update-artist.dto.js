...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Queen' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'https://example.com/artist-image.jpg' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], UpdateArtistDto.prototype, "image", void 0);
